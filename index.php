...
<body>
    ...
    <header>
        ...
        <h1 class="headline-2">MattSobek.com</h1>
        <p class="header-subhead">A Software Developer living near Cleveland, OH.</p>
    </header>
    <section class="about-me">
        <div class="content-wrapper" id="about-me">
            <h2>About Me</h2>
            ...
            <div class="portfolio-cards">
                <div class="portfolio-item">
                    <div>
                        ...
                        <img class="portfolio-screenshot" src="./images/wgu_course_commander.png" alt="WGU Course Commander">
                ...
                <div class="portfolio-item">
                    <div>
                        <h3>MattSobek.com</h3>
                        <img class="portfolio-screenshot" src="./images/mattsobekdotcom.png" alt="MattSobek.com screenshot">
                ...
                <div class="portfolio-item">
                    <div>
                        <h3>Minty Fresh</h3>
                        <img class="portfolio-screenshot" src="./images/minty_fresh.png" alt="Minty Fresh screenshot">
                ...
                <div class="portfolio-item">
                    <div>
                        ...
                        <img class="portfolio-screenshot" src="./images/rock_paper_scissors.png" alt="Rock Paper Scissors">
                ...
                <div class="portfolio-item">
                    <div>
                        <h3>The Summit</h3>
                        <img class="portfolio-screenshot" src="./images/the_summit.png" alt="The Summit">
    ...
    <section class="contact">
        <div class="content-wrapper" id="contact">
            ...
            <form class="email-form" id='email-form' method="POST">
                ...
                <input class="first-name-input" type="text" name="first-name" required>
                <label class="last-name-label" for="last-name">Last Name:</label>
                <input class="last-name-input" type="text" name="last-name" required>
